...
stock_data_1 = get_crypto_data(ticker,
                            ...
                            "2020-01-01",
                            time_resolution='1d')
stock_data_2 = get_crypto_data(ticker,
                            "2020-01-01",
                            "2021-01-01",
                            time_resolution='1d')
stock_data_3 = get_crypto_data(ticker,
                            "2021-01-01",
                            "2022-01-01",
                            time_resolution='1d')
stock_data_4 = get_crypto_data(ticker,
                            "2018-01-01",
                            "2019-01-01",
                            time_resolution='1d')
stock_data_5 = get_crypto_data(ticker,
                            "2018-01-01",
                            "2022-01-01",
                            time_resolution='1d')
stock_data_6 = get_crypto_data(ticker,
                            "2021-12-01",
                            "2022-08-15",
                            time_resolution='1d')
